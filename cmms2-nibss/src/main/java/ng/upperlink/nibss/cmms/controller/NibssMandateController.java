...
public class NibssMandateController {
   ...
   //private Logger log = LoggerFactory.getLogger(NibssMandateController.class);
    ...
    public ResponseEntity createMandate(@Valid @RequestBody MandateRequest requestObject,
        ...
        mandateValidator.validate(requestObject, result);
...
//
//            if (!mandateService.verifyUserRole(new String[]{RoleName.NIBSS_INITIATOR.getValue(), RoleName.NIBSS_AUTHORIZER.getValue(), RoleName.NIBSS_USER.getValue()}, role)) {
