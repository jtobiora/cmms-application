...
public class ApplicationSchedule {
    ...
    public void moveDueDailyMandates() {
        ...
        log.trace(".: The total number of mandates fetched for the date {} is {}", CommonUtils.convertDateToString(new Date(), "yyyy-MM-dd HH:mm:ss"), dueMandates.size());
        dueMandates.stream().forEach((m) -> {
            ...
            log.trace("The next debit date for the mandate code {} is {}; startDate :: {}; endDate :: {}; currentDebitDate :: {};", m.getMandateCode(), m.getStartDate(), m.getEndDate(),
        ...
        log.trace("The migration of due mandates to the transaction table took {} minutes", timeElapsed);
    }
